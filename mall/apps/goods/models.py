...
class SKU(BaseModel):
    ...
    default_image_url = models.CharField(max_length=200, default=None, null=True, blank=True, verbose_name='默认图片')
...
class SKUImage(BaseModel):
    ...
    image = models.ImageField(verbose_name='图片',null=True)
